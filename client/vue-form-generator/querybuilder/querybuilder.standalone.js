//import './query-builder.default.min.css';
...
export default function () {
    !function (a, b) {
        /*"function" == typeof define && define.amd ? define("jQuery.extendext", ["jquery"], b) : "object" == typeof module && module.exports ?
        module.exports = b(require("jquery")) : b(a.jQuery) */
        try {
            fakeModule.exports = b ();
        } catch (e) {
            console.error(e);
        }
    } (window, function () {
        ...
        function () {
            ...
            d.encodeHTMLSource = function (a) {
                ...
                "undefined" != typeof module && fakeModule.exports ? fakeModule.exports = d : "function" == typeof define && define.amd ? define ("doT", function () {
                    return d
                }) : c.doT = d;
        ...
        function (a, b) {
            "function" == typeof define && define.amd ?
                define ("query-builder", ["jquery", "doT"/*, "jQuery.extendext"*/], b) :
                b ($, a.doT)
        } (this, function ($, a) {
            "use strict";
            ...
            g.templates = {}, g.regional = {}, g.OPERATORS = {
                ...
                !function a (b) {
                    (!b.flags || b.flags && !b.flags.condition_readonly) && b.$el.find (">" + h.group_condition).prop ("disabled", b.rules.length <= 1).parent ().toggleClass ("disabled", b.rules.length <= 1), b.each (function (a) {
                    }, function (b) {
                        a (b)
                    }, this)
                } (this.model.root)
