...
const MODULE_NAME = 'loggerGlobalLogs';
...
export default [{
        ...
        meta: {
            title: async function () {
                ...
                return `Изменить глобальную запись лога "${this.model.name}"`;
            },
            breadcrumbs: {
        ...
        props: {
            ...
            query: {
                ...
                update (data) {
                    this.rows = data.loggerGlobalLogs.list.rows;
                    this.totalRecords = data.loggerGlobalLogs.list.total;
                }
            }
        }
    }
